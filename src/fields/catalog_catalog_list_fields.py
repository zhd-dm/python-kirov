...
KEY_AND_VALUE = { T_CATALOG_CATALOG_LIST_FIELDS_KEYS[i]: T_CATALOG_CATALOG_LIST_FIELDS_VALUES[i] for i in range(len(T_CATALOG_CATALOG_LIST_FIELDS_KEYS)) }
...
CATALOG_CATALOG_LIST_CONFIG.update(KEY_AND_VALUE)

print(T_CATALOG_CATALOG_LIST_FIELDS_VALUES)